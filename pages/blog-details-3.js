                  ...
                  <div className='dlab-post-text'>
                    ...
                    <blockquote className='blockquote style-3'>
                      <h4 className='blockquote-content'>
                        Integer accumsan lacinia nulla ac maximus. In dapibus
                        est vel risus tincidunt, nec dignissim eros suscipit.
                        ...
                        >
                          ...
                          <p className='form-submit'>
                            <input
                              type='submit'
                              value='Submit Now'
                              className='submit btn btn-corner gradient btn-primary'
                              id='submit'
                              name='submit'
                            />
                          </p>
